...
// Clear the client catalog cache so the newly registered content is visible
// if the RHD UI was opened during campaign startup.
[] remoteExecCall ["RHD_fnc_fpvGetCatalog", -2];
