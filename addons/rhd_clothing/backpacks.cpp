// RHD - LifeCore 16 Backpack Line
// Uses existing Arma 3 backpack geometries as bases; each class is a normal
// equipable backpack item with 150 cargo-load units.
...
class RHD_Bag_Executive: B_TacticalPack_blk
{
    scope = 2;
    scopeArsenal = 2;
    displayName = "RHD Backpack | Executive";
    descriptionShort = "Discrete black tactical backpack for executive protection and VIP roles.";
    maximumLoad = 150;
    mass = 25;
};

class RHD_Bag_Cargo: B_Carryall_oli
{
    scope = 2;
    scopeArsenal = 2;
    displayName = "RHD Backpack | Cargo Utility";
    descriptionShort = "Large-profile utility backpack for logistics and field support.";
    maximumLoad = 150;
    mass = 25;
};
