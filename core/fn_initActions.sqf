...
player addAction ["Vehicle: Refuel at station", {[] call RHD_fnc_requestRefuel}, nil, 1.5, true, true, "", "(vehicle player) != player && {(driver vehicle player) isEqualTo player}", 5, false, ""];
