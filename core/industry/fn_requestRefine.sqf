...
private _input = switch (_m) do {
    case "rhd_refine_iron": {"iron_ore"}; case "rhd_refine_copper": {"copper_ore"};
    case "rhd_refine_gold": {"gold_ore"}; case "rhd_refine_oil": {"oil_sand"}; default {""}
};
