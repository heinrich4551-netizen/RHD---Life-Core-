/*
    ...
    ACE3 is the contextual interaction layer.
    The RHD Life RP Systems module in 3DEN decides which RHD systems exist.

    ADMIN remains separate from the player tablet and is available to UID-
    allowlisted administrators whenever the RHD Life module is active.
*/
...
// ============================================================================
// ADMINISTRATION - ALWAYS SEPARATE FROM PLAYER TABLET
// ============================================================================
...
// ============================================================================
if (missionNamespace getVariable ["RHD_LIFE_ENABLE_RP", true]) then {
    private _emsAction = [
        "RHD_EmsTreat",
